...
$query = "select a.id, b.nomgare, c.nomgare, a.horairedepart, a.duree from tgv a inner join gare b on a.idgaredepart=b.id inner join gare c on a.idgarearrivee=c.id order by horairedepart";
